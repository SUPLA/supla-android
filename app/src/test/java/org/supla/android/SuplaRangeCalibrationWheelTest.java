...
public class SuplaRangeCalibrationWheelTest extends TestCase {
  ...
  public void testMaximumValueSetterAndGetter() {
    ...
    Assert.assertEquals(calibrationWheel.getMinimumRange(), calibrationWheel.getMaximumValue(), 0);
    Assert.assertEquals(0, calibrationWheel.getMinimum(), 0);
    Assert.assertEquals(0, calibrationWheel.getLeftEdge(), 0);
    Assert.assertEquals(calibrationWheel.getMinimumRange(), calibrationWheel.getMaximum(), 0);
    Assert.assertEquals(calibrationWheel.getMinimumRange(), calibrationWheel.getRightEdge(), 0);
  ...
  public void testMinimumRangeSetterAndGetter() {
    ...
    Assert.assertTrue(
        calibrationWheel.getRightEdge() - calibrationWheel.getLeftEdge()
    ...
    Assert.assertTrue(
        calibrationWheel.getMaximum() - calibrationWheel.getMinimum()
            >= calibrationWheel.getMinimumRange());
    ...
    Assert.assertEquals(calibrationWheel.getMaximumValue(), calibrationWheel.getMinimumRange(), 0);
    Assert.assertEquals(0, calibrationWheel.getLeftEdge(), 0);
    Assert.assertEquals(calibrationWheel.getMaximumValue(), calibrationWheel.getRightEdge(), 0);
    Assert.assertEquals(0, calibrationWheel.getMinimum(), 0);
    Assert.assertEquals(calibrationWheel.getMaximumValue(), calibrationWheel.getMaximum(), 0);
