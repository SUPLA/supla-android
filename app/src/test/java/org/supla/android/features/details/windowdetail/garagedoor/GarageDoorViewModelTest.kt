...
class GarageDoorViewModelTest :
  BaseViewModelTest<GarageDoorViewModelState, BaseWindowViewEvent, GarageDoorViewModel>(MockSchedulers.MOCKK) {
  ...
  private fun mockOnlineChannel(
    ...
    function: SuplaFunction = SuplaFunction.ROLLER_GARAGE_DOOR
  ) {
  ...
  private fun mockOnlineGroup(
    ...
    val groupData: ChannelGroupDataEntity = mockk {
      ...
      every { this@mockk.remoteId } returns remoteId
      every { this@mockk.function } returns SuplaFunction.ROLLER_GARAGE_DOOR
