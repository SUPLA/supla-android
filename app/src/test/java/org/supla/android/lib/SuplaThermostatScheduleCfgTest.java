...
public class SuplaThermostatScheduleCfgTest {
  ...
  public void testGettingGroupWeekDays() {
    ...
    Assert.assertEquals(SuplaThermostatScheduleCfg.DayOfWeek.WEDNESDAY, cfg.getGroupWeekDays(0));
    Assert.assertEquals(SuplaThermostatScheduleCfg.DayOfWeek.THURSDAY, cfg.getGroupWeekDays(1));
  ...
  public void testGettingGroupHourValueType() {
    ...
    Assert.assertEquals(
        SuplaThermostatScheduleCfg.HourValueType.TEMPERATURE, cfg.getGroupHourValueType(0));
    ...
    Assert.assertEquals(
        SuplaThermostatScheduleCfg.HourValueType.PROGRAM, cfg.getGroupHourValueType(0));
  }
