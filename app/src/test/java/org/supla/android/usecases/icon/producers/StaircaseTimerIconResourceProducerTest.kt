...
class StaircaseTimerIconResourceProducerTest : BaseIconResourceProducerTest() {
  ...
  @InjectMocks
  override lateinit var producer: StaircaseTimerIconResourceProducer
  ...
  fun `should produce on icon`() {
    test(
      ...
      expectedIcon = R.drawable.fnc_staircasetimer_on
    )
  }
  ...
  fun `should produce off icon`() {
    test(
      ...
      function = SuplaFunction.STAIRCASE_TIMER,
      expectedIcon = R.drawable.fnc_staircasetimer_off
    )
  }
