...
public class EncryptionTest {
  ...
  public void testPasswordAlignment() {
    ...
    decrypted =
        Encryption.decryptDataWithNullOnException(encrypted, "X000000000000000000000000000000Y");
    assertNull(decrypted);

    decrypted =
        Encryption.decryptDataWithNullOnException(encrypted, "X0000000000000000000000000000000Y");
