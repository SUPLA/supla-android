...
import org.supla.android.features.details.rgbanddimmer.dimmer.DimmerScreen
import org.supla.android.features.details.rgbanddimmer.dimmercct.DimmerCctScreen
import org.supla.android.features.details.rgbanddimmer.rgb.RgbScreen
...
import org.supla.android.features.details.windowdetail.projectorscreen.ProjectorScreen
  ...
  Scaffold(
    ...
    CompositionLocalProvider(LocalScaffoldPadding provides paddings) {
      when (page) {
        ...
        DetailPage.PROJECTOR_SCREEN -> ProjectorScreen(item, navigator)
        ...
        DetailPage.RGB -> RgbScreen(item)
        DetailPage.DIMMER -> DimmerScreen(item)
        DetailPage.DIMMER_CCT -> DimmerCctScreen(item)
      }
    }
  }
}
