...
import org.supla.android.db.room.app.migrations.MIGRATION_48_49
import org.supla.android.db.room.app.migrations.MIGRATION_49_50
...
class DatabaseModule {
  ...
  @Provides
  @Singleton
  fun provideChannelStateDao(appDatabase: AppDatabase) =
    appDatabase.channelStateDao()
  ...
  @Provides
  @Singleton
  fun provideNfcCallDao(appDatabase: AppDatabase) =
    appDatabase.nfcCallDao()
