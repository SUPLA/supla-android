...
public class ListViewDragListener implements View.OnDragListener {
    ...
    public ListViewDragListener(@NonNull ListView listView, @NonNull OnDropListener onDropListener,
    ...
    public boolean onDrag(View v, DragEvent event) {
        ...
        switch (action) {
            ...
            case DragEvent.ACTION_DRAG_LOCATION:
                onPositionChangeListener.onPositionChanged(listView.pointToPosition((int) event.getX(), (int) event.getY()));
                return false;
