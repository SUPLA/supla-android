...
public class ChannelBaseLayout extends LinearLayout {
    ...
    public ChannelBaseLayout(Context context, ChannelListView parentListView) {
        super(context);
    ...
    public ChannelBaseLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ChannelBaseLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setChannelData(ChannelBase cbase) {
        ...
        right_dot.setOn(cbase.getOnLine());
