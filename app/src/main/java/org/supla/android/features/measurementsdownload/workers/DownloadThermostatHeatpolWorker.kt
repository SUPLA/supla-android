...
class DownloadThermostatHeatpolWorker @AssistedInject constructor(
...
) : BaseDownloadLogWorker<ThermostatMeasurement, ThermostatHeatpolLogEntity>(
  appContext,
  workerParameters,
  ...
  companion object {
    val WORK_ID: String = DownloadThermostatHeatpolWorker::class.java.simpleName

    fun build(remoteId: Int, profileId: Long): OneTimeWorkRequest =
      OneTimeWorkRequestBuilder<DownloadThermostatHeatpolWorker>()
