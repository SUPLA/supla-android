...
class RemoveHiddenScenesWorker @AssistedInject constructor(
  ...
  private val removeHiddenScenesUseCase: RemoveHiddenScenesUseCase
  ...
  companion object {
    val WORK_ID: String = RemoveHiddenScenesUseCase::class.java.simpleName
    val TAG: String = RemoveHiddenScenesUseCase::class.java.simpleName

    fun build(): OneTimeWorkRequest =
      OneTimeWorkRequestBuilder<RemoveHiddenScenesWorker>()
        .addTag(TAG)
        .build()
  }
}
