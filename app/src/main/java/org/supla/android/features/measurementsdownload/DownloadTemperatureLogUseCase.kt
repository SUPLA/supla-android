...
@Singleton
class DownloadTemperatureLogUseCase @Inject constructor(
  temperatureLogRepository: TemperatureLogRepository,
  suplaCloudServiceProvider: SuplaCloudService.Provider
) : BaseDownloadLogUseCase<TemperatureMeasurement, TemperatureLogEntity>(suplaCloudServiceProvider, temperatureLogRepository)
