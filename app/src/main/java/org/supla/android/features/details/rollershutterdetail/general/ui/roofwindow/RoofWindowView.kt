...
private fun Camera.asDynamic(windowDimens: RoofWindowDimens, roofWindowState: WindowState): Camera {
  setLocation(0f, 0f, windowDimens.canvasRect.size.width.times(-1))
  translate(windowDimens.canvasRect.size.center.x, windowDimens.canvasRect.size.center.y * -1, 0f)
  rotateZ(180f)
  rotateY(210f)
...
val WindowState.openedOffset: Float
  get() = MAX_OPENED_OFFSET.times(100f.minus(position)).div(100f)
