package org.supla.android.features.details.thermometerdetail
/*
...
) : StandardDetailViewModel<ThermometerDetailViewState, ThermometerDetailViewEvent>(
  readChannelByRemoteIdUseCase,
  readChannelGroupByRemoteIdUseCase,
  updateEventsManager,
  preferences,
  ThermometerDetailViewState(),
  schedulers
) {
...
sealed interface ThermometerDetailViewEvent : StandardDetailViewEvent {
  object Close : ThermometerDetailViewEvent
}
