...
import org.supla.android.features.details.rgbanddimmer.rgb.ui.View

private const val ARG_ITEM_BUNDLE = "ARG_ITEM_BUNDLE"

@AndroidEntryPoint
class RgbDetailFragment : BaseComposeFragment<RgbDetailModelState, RgbDetailViewEvent>() {
  override val viewModel: RgbDetailViewModel by viewModels()
  ...
  override fun handleEvents(event: RgbDetailViewEvent) {
    when (event) {
      RgbDetailViewEvent.ShowColorsLimitReached ->
