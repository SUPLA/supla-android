package org.supla.android.features.details.switchdetail.timersdetail
/*
...
class TimerConfigurationView @JvmOverloads constructor(
  ...
  private fun updatePrimaryButtonText() {
    binding.detailsTimerStartButton.setText(if (editMode) R.string.save else R.string.details_timer_start)
  }
