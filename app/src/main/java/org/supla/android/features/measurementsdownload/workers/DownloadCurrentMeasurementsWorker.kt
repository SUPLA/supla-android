...
class DownloadCurrentMeasurementsWorker @AssistedInject constructor(
  ...
  companion object {
    val WORK_ID: String = DownloadCurrentMeasurementsWorker::class.java.simpleName

    fun build(remoteId: Int, profileId: Long): OneTimeWorkRequest =
      OneTimeWorkRequestBuilder<DownloadCurrentMeasurementsWorker>()
        .setInputData(data(remoteId, profileId, DownloadEventsManager.DataType.ELECTRICITY_CURRENT_TYPE))
