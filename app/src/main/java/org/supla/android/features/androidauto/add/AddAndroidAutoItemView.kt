...
import org.supla.android.ui.views.LabelledSpinner
import org.supla.android.ui.views.LabelledSpinnerItem
...
fun AddAndroidAutoItemScope.View(viewState: AddAndroidAutoItemViewState) {
  ...
  Box {
    Column(
      ...
      viewState.subjects?.let { Subjects(it) }
...
@Composable
private fun AddAndroidAutoItemScope.Profile(profiles: SingleSelectionList<ProfileItem>) =
  Spinner(
    options = profiles,
    fillMaxWidth = true,
...
@Composable
private fun AddAndroidAutoItemScope.Subjects(subjects: SingleSelectionList<SubjectItem>) =
  LabelledSpinner(
    options = subjects,
    fillMaxWidth = true,
...
private fun Preview() {
  ...
  val firstSubject = SubjectItem(1, LocalizedString.Constant("Thermostat"), emptyList(), false)
  SuplaTheme {
    emptyScope.View(
