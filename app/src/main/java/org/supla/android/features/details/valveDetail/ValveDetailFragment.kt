...
@AndroidEntryPoint
class ValveDetailFragment :
  StandardDetailFragment<ValveDetailViewState, ValveDetailViewEvent>(R.layout.fragment_standard_detail) {

  override val viewModel: ValveDetailViewModel by viewModels()
  ...
  override fun isCloseEvent(event: ValveDetailViewEvent) = event == ValveDetailViewEvent.Close

  override fun updateToolbarTitle(state: ValveDetailViewState) {
