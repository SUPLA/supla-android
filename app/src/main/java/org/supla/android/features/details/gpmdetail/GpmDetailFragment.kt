...
@AndroidEntryPoint
class GpmDetailFragment :
  StandardDetailFragment<GpmDetailViewState, GpmDetailViewEvent>(R.layout.fragment_standard_detail) {

  override val viewModel: GpmDetailViewModel by viewModels()
