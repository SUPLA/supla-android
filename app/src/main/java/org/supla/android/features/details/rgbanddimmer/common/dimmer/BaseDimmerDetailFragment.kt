...
@AndroidEntryPoint
abstract class BaseDimmerDetailFragment : BaseComposeFragment<DimmerDetailModelState, DimmerDetailViewEvent>() {
  abstract override val viewModel: BaseDimmerDetailViewModel
