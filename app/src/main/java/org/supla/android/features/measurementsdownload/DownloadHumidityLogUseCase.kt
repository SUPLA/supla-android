...
@Singleton
class DownloadHumidityLogUseCase @Inject constructor(
  humidityLogRepository: HumidityLogRepository,
  suplaCloudServiceProvider: SuplaCloudService.Provider
) : BaseDownloadLogUseCase<HumidityMeasurement, HumidityLogEntity>(suplaCloudServiceProvider, humidityLogRepository)
