...
@AndroidEntryPoint
class ElectricityMeterDetailFragment :
  StandardDetailFragment<ElectricityMeterDetailViewState, ElectricityMeterDetailViewEvent>(R.layout.fragment_standard_detail) {

  override val viewModel: ElectricityMeterDetailViewModel by viewModels()
  ...
  override fun isCloseEvent(event: ElectricityMeterDetailViewEvent) = event == ElectricityMeterDetailViewEvent.Close

  override fun updateToolbarTitle(state: ElectricityMeterDetailViewState) {
