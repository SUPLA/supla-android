...
@Singleton
class DownloadTemperatureAndHumidityLogUseCase @Inject constructor(
...
) : BaseDownloadLogUseCase<TemperatureAndHumidityMeasurement, TemperatureAndHumidityLogEntity>(
