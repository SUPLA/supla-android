...
public class ChannelDetailTemperature extends DetailLayout
  ...
  public ChannelDetailTemperature(
      Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    super(context, attrs, defStyleAttr, defStyleRes);
  }

  protected DownloadMeasurementLogs getDMLInstance() {
    return new DownloadTemperatureMeasurements(
        getContext(), profileIdHolder.getProfileId().intValue());
  }
  ...
  public void onDetailShow() {
    ...
    tvProgress.setVisibility(INVISIBLE);
    onClick(ivGraph);
    chartHelper.restoreSpinner(getChannelBase().getFunc(), thSpinner);
  ...
  public void onDetailHide() {
    ...
    chartHelper.persistSpinner(getChannelBase().getFunc(), thSpinner);
  ...
  protected void onSpinnerItemSelected() {
    ...
    onItemSelected(null, null, thSpinner.getSelectedItemPosition(), thSpinner.getSelectedItemId());
