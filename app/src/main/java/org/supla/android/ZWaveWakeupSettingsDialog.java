...
public class ZWaveWakeupSettingsDialog implements DialogInterface.OnDismissListener,
    ...
    public void onWakeUpSettingsReport(int result, ZWaveWakeUpSettings settings) {
        ...
        if (result == SuplaConst.SUPLA_CALCFG_RESULT_TRUE && settings != null) {
            ...
            showError(activity.getResources().getString(R.string.zwave_unexpected_answer,
