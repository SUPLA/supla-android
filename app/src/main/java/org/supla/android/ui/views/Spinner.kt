...
interface LabelledSpinnerItem : SpinnerItem {
  val isLabel: Boolean
}

@Composable
fun <T : LabelledSpinnerItem> LabelledSpinner(
          ...
          DropdownMenuItem(
            text = {
              Text(
                ...
                color = if (option.isLabel) MaterialTheme.colorScheme.onSurfaceVariant else MaterialTheme.colorScheme.onSurface
              )
            },
            onClick = {
              if (!option.isLabel) {
