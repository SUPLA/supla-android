...
public class TempHumidityLogDao extends MeasurementsBaseDao {
  ...
  public Cursor getTempHumidityMeasurements(int channelId, Date dateFrom, Date dateTo) {
    StringBuilder sqlBuilder =
        new StringBuilder()
            .append("SELECT ")
            .append(SuplaContract.TempHumidityLogEntry.COLUMN_NAME_TEMPERATURE)
            .append(", ")
            .append(SuplaContract.TempHumidityLogEntry.COLUMN_NAME_HUMIDITY)
            .append(", ")
            .append(SuplaContract.TempHumidityLogEntry.COLUMN_NAME_TIMESTAMP)
            .append(" FROM ")
            .append(SuplaContract.TempHumidityLogEntry.TABLE_NAME)
            .append(" WHERE ")
            .append(SuplaContract.TempHumidityLogEntry.COLUMN_NAME_CHANNELID)
            .append(" = ")
            .append(channelId);
    ...
    if (dateFrom != null && dateTo != null) {
      sqlBuilder
          ...
          .append(SuplaContract.TempHumidityLogEntry.COLUMN_NAME_TIMESTAMP)
          .append(" >= ")
          .append(toMilis(dateFrom))
          .append(" AND ")
          .append(SuplaContract.TempHumidityLogEntry.COLUMN_NAME_TIMESTAMP)
          .append(" <= ")
          .append(toMilis(dateTo));
    }
    sqlBuilder
        .append(" ORDER BY ")
        .append(SuplaContract.TempHumidityLogEntry.COLUMN_NAME_TIMESTAMP)
