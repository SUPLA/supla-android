...
class ThermostatHeatpolLogRepository @Inject constructor(
...
) : BaseMeasurementRepository<ThermostatMeasurement, ThermostatHeatpolLogEntity>(thermostatHeatpolLogDao),
  ...
  override suspend fun deleteChannelRelated(remoteId: Int, profileId: Long) = thermostatHeatpolLogDao.deleteKtx(remoteId, profileId)
}
