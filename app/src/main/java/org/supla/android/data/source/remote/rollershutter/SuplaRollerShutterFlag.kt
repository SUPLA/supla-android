...
enum class SuplaRollerShutterFlag(val value: Int) {
  TILT_IS_SET(1),
  ...
  companion object {
    fun from(value: Int): List<SuplaRollerShutterFlag> {
      val result = mutableListOf<SuplaRollerShutterFlag>()
      for (flag in SuplaRollerShutterFlag.values()) {
