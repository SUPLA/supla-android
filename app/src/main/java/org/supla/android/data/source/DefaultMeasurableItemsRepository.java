...
public class DefaultMeasurableItemsRepository implements MeasurableItemsRepository {
    ...
    public double getLastElectricityMeterMeasurementValue(int monthOffset, int channelId, boolean production) {
        return electricityMeterLogDao.getLastElectricityMeterMeasurementValue(monthOffset, channelId, production);
    }
    ...
    public int getElectricityMeterMeasurementTotalCount(int channelId, boolean withoutComplement) {
        return electricityMeterLogDao.getElectricityMeterMeasurementTotalCount(channelId, withoutComplement);
    }
    ...
    public Cursor getElectricityMeasurementsCursor(int channelId, String groupByDateFormat, Date dateFrom, Date dateTo) {
        return electricityMeterLogDao.getElectricityMeasurementsCursor(channelId, groupByDateFormat, dateFrom, dateTo);
    }
    ...
    public int getImpulseCounterMeasurementTotalCount(int channelId, boolean withoutComplement) {
        return impulseCounterLogDao.getImpulseCounterMeasurementTotalCount(channelId, withoutComplement);
    }
