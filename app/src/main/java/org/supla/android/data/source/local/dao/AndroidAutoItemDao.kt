...
@Dao
interface AndroidAutoItemDao {
  @Insert(onConflict = OnConflictStrategy.REPLACE)
  fun insert(item: AndroidAutoItemEntity): Completable
  ...
  fun findById(id: Long): Observable<AndroidAutoItemEntity>
  ...
  fun findAll(): Observable<List<AndroidAutoDataEntity>>
