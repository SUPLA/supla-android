...
data class AndroidAutoItemEntity(
  ...
  companion object {
    const val TABLE_NAME = "android_auto_item"
    ...
    const val ALL_COLUMNS = "$COLUMN_ID, $COLUMN_SUBJECT_ID, $COLUMN_SUBJECT_TYPE, $COLUMN_CAPTION, $COLUMN_ACTION, $COLUMN_PROFILE_ID"
  }
}