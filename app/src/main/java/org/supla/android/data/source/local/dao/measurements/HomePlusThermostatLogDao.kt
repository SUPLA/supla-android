...
import org.supla.android.data.source.local.entity.measurements.HomePlusThermostatLogEntity.Companion.ALL_COLUMNS
import org.supla.android.data.source.local.entity.measurements.HomePlusThermostatLogEntity.Companion.COLUMN_CHANNEL_ID
import org.supla.android.data.source.local.entity.measurements.HomePlusThermostatLogEntity.Companion.COLUMN_GROUPING_STRING
import org.supla.android.data.source.local.entity.measurements.HomePlusThermostatLogEntity.Companion.COLUMN_MEASURED_TEMPERATURE
...
@Dao
interface HomePlusThermostatLogDao : GroupingStringMigratorDao {

  @Insert(onConflict = OnConflictStrategy.REPLACE)
  fun insert(entity: List<HomePlusThermostatLogEntity>): Completable
  ...
  fun findOldestEntity(channelId: Int, profileId: Long): Maybe<HomePlusThermostatLogEntity>
  ...
  fun findMeasurements(channelId: Int, profileId: Long, startDate: Long, endDate: Long): Observable<List<HomePlusThermostatLogEntity>>
