...
public class TemperatureLogDao extends MeasurementsBaseDao {
  ...
  public Cursor getTemperatureMeasurements(int channelId, Date dateFrom, Date dateTo) {
    ...
    StringBuilder sqlBuilder =
        new StringBuilder()
            .append("SELECT ")
            .append(SuplaContract.TemperatureLogEntry.COLUMN_NAME_TEMPERATURE)
            .append(", ")
            .append(SuplaContract.TemperatureLogEntry.COLUMN_NAME_TIMESTAMP)
            .append(" FROM ")
            .append(SuplaContract.TemperatureLogEntry.TABLE_NAME)
            .append(" WHERE ")
            .append(SuplaContract.TemperatureLogEntry.COLUMN_NAME_CHANNELID)
            .append(" = ")
            .append(channelId);
