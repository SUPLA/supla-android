...
import org.supla.android.data.source.local.entity.measurements.ThermostatHeatpolLogEntity.Companion.ALL_COLUMNS
import org.supla.android.data.source.local.entity.measurements.ThermostatHeatpolLogEntity.Companion.COLUMN_CHANNEL_ID
import org.supla.android.data.source.local.entity.measurements.ThermostatHeatpolLogEntity.Companion.COLUMN_GROUPING_STRING
import org.supla.android.data.source.local.entity.measurements.ThermostatHeatpolLogEntity.Companion.COLUMN_MEASURED_TEMPERATURE
import org.supla.android.data.source.local.entity.measurements.ThermostatHeatpolLogEntity.Companion.COLUMN_PROFILE_ID
import org.supla.android.data.source.local.entity.measurements.ThermostatHeatpolLogEntity.Companion.COLUMN_TIMESTAMP
import org.supla.android.data.source.local.entity.measurements.ThermostatHeatpolLogEntity.Companion.TABLE_NAME

@Dao
interface ThermostatHeatpolLogDao: GroupingStringMigratorDao {
  @Insert(onConflict = OnConflictStrategy.REPLACE)
  fun insert(entity: List<ThermostatHeatpolLogEntity>): Completable
  ...
  fun findOldestEntity(channelId: Int, profileId: Long): Maybe<ThermostatHeatpolLogEntity>

  @Query("SELECT COUNT($COLUMN_MEASURED_TEMPERATURE) FROM $TABLE_NAME WHERE channelid = :channelId AND profileid = :profileId")
  ...
  fun findMeasurements(channelId: Int, profileId: Long, startDate: Long, endDate: Long): Observable<List<ThermostatHeatpolLogEntity>>
