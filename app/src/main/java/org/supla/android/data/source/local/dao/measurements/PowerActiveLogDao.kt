...
import org.supla.android.data.source.local.entity.measurements.PowerActiveHistoryLogEntity.Companion.ALL_COLUMNS
import org.supla.android.data.source.local.entity.measurements.PowerActiveHistoryLogEntity.Companion.COLUMN_CHANNEL_ID
import org.supla.android.data.source.local.entity.measurements.PowerActiveHistoryLogEntity.Companion.COLUMN_GROUPING_STRING
import org.supla.android.data.source.local.entity.measurements.PowerActiveHistoryLogEntity.Companion.COLUMN_ID
...
@Dao
interface PowerActiveLogDao : GroupingStringMigratorDao {
  @Insert(onConflict = OnConflictStrategy.REPLACE)
  fun insert(entity: List<PowerActiveHistoryLogEntity>): Completable
  ...
  fun findOldestEntity(channelId: Int, profileId: Long): Maybe<PowerActiveHistoryLogEntity>
