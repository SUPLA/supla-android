...
abstract class WidgetConfigurationActivityBase<T : Any> : FragmentActivity() {
    ...
    protected fun profileItemSelectedListener(adapter: WidgetConfigurationSpinnerBase<AuthProfileItem>) = object : AdapterView.OnItemSelectedListener {
        ...
        viewModel().confirmationResult.observe(this) {
            when {
                ...
                it.exceptionOrNull() is EmptyDisplayNameException ->
                    ...
                    Trace.e(WidgetConfigurationActivityBase<*>::javaClass.name,
