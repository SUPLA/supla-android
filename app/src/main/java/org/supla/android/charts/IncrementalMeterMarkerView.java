...
public class IncrementalMeterMarkerView extends SuplaMarkerView {
  ...
  public IncrementalMeterMarkerView(
      IncrementalMeterChartHelper helper, Context context, int layoutResource) {
    ...
    if (helper instanceof IncrementalMeterChartHelper) {
      ...
      if (helper.getCurrency() != null) {
        return String.format(
            "%.2f " + getString(helper.getCurrency()), helper.getPricePerUnit() * e.getY());
      }
    }
