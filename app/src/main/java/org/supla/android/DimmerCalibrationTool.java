...
public abstract class DimmerCalibrationTool
    ...
    final private ChannelDetailRGBW detailRGB;
    final private RelativeLayout mainView;
    ...
    protected void setLedBtnApparance(AppCompatImageView img, boolean selected,
                                    int resIdNormal, int resIdSelected) {
        if (img == null) {
            return;
        }

        Drawable bg =  getResources().getDrawable(selected ? R.drawable.rounded_led_sel_btn
    ...
    protected void setLedConfig(DeviceCfgParameters params) {
        setLedConfig(params.getLedConfig() != null
