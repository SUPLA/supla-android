...
import org.supla.core.shared.usecase.channel.valueformatter.formatters.WeightValueFormatter
...
class WeightSensorValueStringProvider @Inject constructor(
  ...
  override fun value(channelWithChildren: ChannelWithChildren, valueType: ValueType, withUnit: Boolean): String {
    return WeightValueFormatter.format(
      value = weightSensorValueProvider.value(channelWithChildren, valueType),
