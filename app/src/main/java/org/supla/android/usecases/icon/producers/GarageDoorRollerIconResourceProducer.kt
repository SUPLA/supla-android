...
object GarageDoorRollerIconResourceProducer : IconResourceProducer {
  override fun accepts(function: Int): Boolean =
    function == SUPLA_CHANNELFNC_ROLLER_GARAGE_DOOR

  override fun produce(data: IconData): Int =
    when (data.state.value) {
      ChannelState.Value.OPEN -> R.drawable.fnc_roller_garage_door_open
      else -> R.drawable.fnc_roller_garage_door_close
    }
}
