...
class CurtainIconResourceProducer : IconResourceProducer {
  override fun accepts(function: Int): Boolean =
    function == SUPLA_CHANNELFNC_CURTAIN

  override fun produce(data: IconData): Int =
    when (data.state.value) {
      ChannelState.Value.OPEN -> R.drawable.fnc_curtain_open
      else -> R.drawable.fnc_curtain_close
    }
}
