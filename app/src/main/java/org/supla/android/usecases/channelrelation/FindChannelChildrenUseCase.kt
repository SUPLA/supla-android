...
@Singleton
class FindChannelChildrenUseCase @Inject constructor(
  private val channelRepository: ChannelRepository,
  private val channelRelationRepository: ChannelRelationRepository
) {

  operator fun invoke(profileId: Long, remoteId: Int): Maybe<List<ChannelChild>> =
    channelRelationRepository.findChildren(profileId, remoteId).firstElement()
      .flatMap { childrenRelations ->
        Maybe.fromCallable {
