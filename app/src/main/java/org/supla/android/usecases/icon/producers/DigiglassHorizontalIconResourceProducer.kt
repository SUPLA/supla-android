...
class DigiglassHorizontalIconResourceProducer : IconResourceProducer {
  ...
  override fun produce(data: IconData): Int =
    when (data.altIcon) {
      1 -> if (data.state.value == ChannelState.Value.OPAQUE) {
        R.drawable.fnc_digiglass_horizontal_1
      } else {
        ...
        R.drawable.fnc_digiglass_horizontal_transparent
      }
    }
}
