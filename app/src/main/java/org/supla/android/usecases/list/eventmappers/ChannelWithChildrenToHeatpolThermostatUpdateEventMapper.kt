...
@Singleton
class ChannelWithChildrenToHeatpolThermostatUpdateEventMapper @Inject constructor(
  ...
  override fun handle(item: Any): Boolean {
    return (item as? ChannelWithChildren)?.channel?.function == SuplaFunction.THERMOSTAT_HEATPOL_HOMEPLUS
  }
