...
object SmokeSensorIconResourceProducer : IconResourceProducer {
  override fun accepts(function: SuplaFunction): Boolean =
    function == SuplaFunction.SMOKE_SENSOR

  override fun produce(data: IconData): Int =
    data.stateIcon(R.drawable.fnc_binary_sensor_7_on, R.drawable.fnc_binary_sensor_7_off)
}
