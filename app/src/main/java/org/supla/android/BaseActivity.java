...
public class BaseActivity extends FragmentActivity
  ...
  public void onSuplaClientMessageReceived(SuplaClientMsg msg) {
    ...
    switch (msg.getType()) {
      case SuplaClientMsg.onDataChanged:
        onDataChangedMsg(msg.getChannelId(), msg.getChannelGroupId(), msg.isExtendedValue());
        break;
      case SuplaClientMsg.onConnecting:
        onConnectingMsg();
        break;
      ...
      case SuplaClientMsg.onCalCfgResult:
        onCalCfgResult(msg.getChannelId(), msg.getCommand(), msg.getResult(), msg.getData());
        break;
      ...
      case SuplaClientMsg.onCalCfgProgressReport:
        onCalCfgProgressReport(msg.getChannelId(), msg.getCommand(), msg.getProgress());
        break;
    }
  }
  ...
  protected void setStatusBarColor(int colorId) {
    ...
    int navigationBarColor = ResourcesCompat.getColor(getResources(), R.color.channel_cell, null);
