  ...
  public String codeToString(Context context, boolean authDialog) {
    return switch (ResultCode) {
      case SuplaConst.SUPLA_RESULTCODE_TEMPORARILY_UNAVAILABLE ->
          context.getResources().getString(R.string.status_temporarily_unavailable);
      ...
      case SuplaConst.SUPLA_RESULTCODE_CLIENT_LIMITEXCEEDED ->
          context.getResources().getString(R.string.status_climit_exceded);
      case SuplaConst.SUPLA_RESULTCODE_CLIENT_DISABLED ->
          context.getResources().getString(R.string.status_device_disabled);
      case SuplaConst.SUPLA_RESULTCODE_ACCESSID_DISABLED ->
          context.getResources().getString(R.string.status_accessid_disabled);
      case SuplaConst.SUPLA_RESULTCODE_REGISTRATION_DISABLED ->
          context.getResources().getString(R.string.status_reg_disabled);
      case SuplaConst.SUPLA_RESULTCODE_ACCESSID_NOT_ASSIGNED ->
          context.getResources().getString(R.string.status_access_id_not_assigned);
      case SuplaConst.SUPLA_RESULTCODE_ACCESSID_INACTIVE ->
          context.getResources().getString(R.string.status_accessid_inactive);
      default ->
          context.getResources().getString(R.string.status_unknown_err) + " (" + ResultCode + ")";
    };
  }
