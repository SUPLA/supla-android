...
public class ChannelDetailTempHumidity extends ChannelDetailTemperature {
  ...
  public ChannelDetailTempHumidity(
      Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    super(context, attrs, defStyleAttr, defStyleRes);
  }

  protected DownloadMeasurementLogs getDMLInstance() {
    return new DownloadTempHumidityMeasurements(
  ...
  public void setData(ChannelBase cbase) {
    ...
    ivHumidityIcon.setImageBitmap(
        ImageCache.getBitmap(getContext(), cbase.getImageIdx(ChannelBase.WhichOne.Second)));
  }
  ...
  public void onClick(View v) {
    ...
    if (v == cbHumidity || v == cbTemperature) {
      if (v == cbHumidity && !cbHumidity.isChecked() && !cbTemperature.isChecked()) {
        cbTemperature.setChecked(true);
      } else if (v == cbTemperature && !cbTemperature.isChecked() && !cbHumidity.isChecked()) {
