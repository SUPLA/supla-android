...
public class SuplaCfg {
    ...
    void setName(String Name) {
        this.Name = new String(Name.substring(0,SuplaConst.SUPLA_CLIENT_NAME_MAXSIZE-1));
    }

    void setAccessIDpwd(String AccessIDpwd) {
        this.AccessIDpwd = new String(AccessIDpwd.substring(0, SuplaConst.SUPLA_ACCESSID_PWD_MAXSIZE-1));
    }

    void setSoftVer(String SoftVer) {
        this.SoftVer = new String(SoftVer.substring(0, SuplaConst.SUPLA_SOFTVER_MAXSIZE-1));
    }
