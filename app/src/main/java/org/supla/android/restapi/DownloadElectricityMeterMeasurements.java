...
public class DownloadElectricityMeterMeasurements extends DownloadIncrementalMeasurements {
  ...
  protected int getLocalTotalCount() {
    return getMeasurementsDbH().getElectricityMeterMeasurementTotalCount(getChannelId(), true);
  }
  ...
  protected void addIncrementalMeasurement(SQLiteDatabase db, IncrementalMeasurementItem item) {
