...
public abstract class DownloadIncrementalMeasurements extends DownloadMeasurementLogs {
  ...
  protected abstract void addIncrementalMeasurement(
      SQLiteDatabase db, IncrementalMeasurementItem item);
  ...
  protected void SaveMeasurementItem(SQLiteDatabase db, long timestamp, JSONObject obj)
    ...
    boolean correctDateOrder =
        older_item == null || younger_item.getTimestamp() > older_item.getTimestamp();
