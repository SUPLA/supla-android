...
enum class LocalizedStringId {
  ...
  CHANNEL_CAPTION_SMOKE_SENSOR,
  CHANNEL_CAPTION_CARBON_MONOXIDE_SENSOR,
  CHANNEL_CAPTION_GAS_SENSOR,
  ...
  CHANNEL_BATTERY_LOW,
  CHANNEL_BATTERY_LOW_WITH_INFO,
  CHANNEL_BATTERY_LEVEL,
  CHANNEL_BATTERY_LEVEL_WITH_INFO,
  ...
  ADD_WIZARD_CERTIFICATE_ERROR_UNTRUSTED,
  ADD_WIZARD_CERTIFICATE_ERROR_EXPIRED,
  ADD_WIZARD_CERTIFICATE_ERROR_NOT_YET_VALID,
  ADD_WIZARD_CERTIFICATE_ERROR_REVOKED,
  ADD_WIZARD_CERTIFICATE_ERROR_HOST_MISMATCH,
  ADD_WIZARD_CERTIFICATE_ERROR_PIN_MISMATCH,
  ADD_WIZARD_CERTIFICATE_ERROR_UNSUPPORTED_SECURITY,
  ADD_WIZARD_CERTIFICATE_ERROR_DIFFERENT_NAMES,
  ...
  CHANNEL_STATE_BATTERY_LOW_VALUE,
  CHANNEL_STATE_BATTERY_NORMAL_VALUE,
