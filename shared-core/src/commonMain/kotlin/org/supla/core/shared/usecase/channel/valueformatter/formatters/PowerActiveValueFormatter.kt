...
object PowerActiveValueFormatter : ValueFormatter() {
  override val invalidValue: InvalidValue = InvalidValue.None
  override val defaultFormatSpecification: ValueFormatSpecification = ValueFormatSpecification.Companion.PowerActive
}
